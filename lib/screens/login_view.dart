import 'package:chatapp/screens/Register_view.dart';
...
class LogiInView extends StatefulWidget {
  const LogiInView({super.key});

  @override
  State<LogiInView> createState() => _LogiInViewState();
}

class _LogiInViewState extends State<LogiInView> {
